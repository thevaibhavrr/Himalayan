          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <Tabs value={selectedCategory} onValueChange={setSelectedCategory}>
                <TabsList className="grid grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 bg-white">
                  {categories.map((category) => (
                    <TabsTrigger 
                      key={category.id} 
                      value={category.id}
                      className="data-[state=active]:bg-[#FFD233] data-[state=active]:text-[#4B2E2B] text-xs"
                    >
                      {category.name}
                    </TabsTrigger>
                  ))}
            ...
            <div>
              ...
              <Tabs value={selectedSize} onValueChange={setSelectedSize}>
                <TabsList className="grid grid-cols-5 bg-white">
                  {sizes.map((size) => (
                    <TabsTrigger 
                      key={size.id} 
                      value={size.id}
