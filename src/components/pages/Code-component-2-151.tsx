          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <Card className="shadow-xl overflow-hidden">
              ...
              <CardContent className="p-0">
                <div className="w-full h-80 bg-[#FFF8E1] flex items-center justify-center">
                  <div className="text-center">
                    <MapPin className="w-16 h-16 text-[#FFD233] mx-auto mb-4" />
                    <h3 className="text-xl text-[#4B2E2B] mb-2">Interactive Map</h3>
                    <p className="text-[#4B2E2B] opacity-80 mb-2">
                      Industrial Area, Sector-2
                    </p>
                    <p className="text-[#4B2E2B] opacity-80">
                      Greater Noida, UP 201310, India
                    </p>
                    <Button className="mt-4 himalayan-gradient text-white">
                      Get Directions
                    </Button>
                  </div>
                </div>
