            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center p-4 bg-[#FFF8E1] rounded-lg">
                  <Heart className="w-8 h-8 text-[#FFD233] mx-auto mb-2" />
                  <div className="text-sm text-[#4B2E2B] opacity-80">Heart Healthy</div>
                </div>
                <div className="text-center p-4 bg-[#FFF8E1] rounded-lg">
                  <Shield className="w-8 h-8 text-[#FFD233] mx-auto mb-2" />
                  <div className="text-sm text-[#4B2E2B] opacity-80">100% Pure</div>
                </div>
                <div className="text-center p-4 bg-[#FFF8E1] rounded-lg">
                  <Leaf className="w-8 h-8 text-[#FFD233] mx-auto mb-2" />
                  <div className="text-sm text-[#4B2E2B] opacity-80">Chemical Free</div>
                </div>
              </div>
